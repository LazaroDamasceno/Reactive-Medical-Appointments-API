...
import com.api.v1.exceptions.medical_appointments.MedicalAppointmentInadequateBookingDateTimeException;
...
public class MedicalAppointmentBookingServiceImpl implements MedicalAppointmentBookingService {
    ...
    private Mono<Object> onInadequateBookingDateTime(LocalDateTime bookedAt) {
        ...
        return Mono.error(MedicalAppointmentInadequateBookingDateTimeException::new);
    }
}
